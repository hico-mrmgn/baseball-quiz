      ...
      <div className="max-w-2xl lg:max-w-5xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-2">
          <div className="flex items-center gap-1.5">
            ...
            <span className="font-bold text-gray-800 text-sm md:text-base">{themeInfo.name}</span>
          </div>
        ...
        {confirmedAnswer !== null && !isCorrect && comboBreak && (
          <div className="combo-break-msg text-center text-sm font-bold text-amber-700 mb-3 bg-amber-50 rounded-xl p-2.5 border border-amber-200">
            {comboBreakMsg}
          </div>
        )}
